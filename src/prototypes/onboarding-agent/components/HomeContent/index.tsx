 ...
 *
 * The main content area for the Onboarding Agent prototype.
 * Based on DocuSignLanding, adapted to work within the AIPanel layout.
 */
...
export function HomeContent({ userName = 'Akshat Mishra' }: HomeContentProps) {
  return (
