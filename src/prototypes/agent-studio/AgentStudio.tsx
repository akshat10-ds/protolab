/**
 * AgentStudio Prototype
 *
 * AI Agent demonstration for contract analysis with visible reasoning steps.
 * Built on Agreement Studio, enhanced with:
 * - Progressive reasoning visualization (ThinkingSteps)
 * - Agent action cards with execute/cancel
 * - Tool execution feedback
 * - Agentic Q&A patterns
 *
 * Based on Agreement Studio's "Acme Renewal Prep" scenario.
 */
