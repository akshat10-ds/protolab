...
export const QUICK_ACTIONS: ExtendedSuggestedAction[] = [
  {
    ...
    expansion: {
      steps: [
        'Identify the most recent version of each term',
        'Track changes across amendments',
        'Categorize by: Financials, Risk/Liability, Key Changes',
  ...
  },
  {
    ...
    expansion: {
      steps: [
        'Extract all pricing and payment terms',
        'Compare values across order forms',
        'Identify volume discounts and tiers',
  ...
  },
  {
    ...
    expansion: {
      steps: [
        'Compare terms across all agreement versions',
        'Identify contradictory clauses',
        'Determine which document takes precedence',
